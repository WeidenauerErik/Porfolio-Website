  ...
  <div style="position: relative; overflow-x: clip; background: #fff; min-height: 100vh; display: flex; flex-direction: column;">
    ...
    <header class="nav-header">
      <nav class="nav-inner">
        ...
        <div class="nav-links desktop-only">
          ...
          >
            <component :is="link.Icon" :size="15" style="opacity:0.55;" />
            {{ link.label }}
      ...
      <div v-if="menuOpen" class="mobile-menu">
        <RouterLink
          ...
          @click="closeMenu"
        >
          <component :is="link.Icon" :size="19" style="color: #2563EB;" />
          {{ link.label }}
        </RouterLink>
      </div>
    </header>
    ...
    <footer class="site-footer">
      <div class="footer-inner">
        <div>
          <RouterLink to="/" class="nav-logo" style="margin-bottom: 14px; display: inline-flex;">
            <Code2 :size="20" />
            Erik Weidenauer
          </RouterLink>
        ...
        <div>
          ...
          <div style="display: flex; flex-direction: column; gap: 11px;">
            <RouterLink
              ...
              class="footer-link"
            >
              <component :is="link.Icon" :size="15" style="opacity: 0.6;" />
              {{ link.label }}
            </RouterLink>
          </div>
        </div>
        <div>
          ...
          <div style="display: flex; flex-direction: column; gap: 11px;">
            ...
            <a href="https://www.linkedin.com/in/erik-weidenauer" target="_blank" rel="noopener" class="footer-link">
              <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="opacity:0.6;display:block;flex-shrink:0;"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"/><rect width="4" height="12" x="2" y="9"/><circle cx="4" cy="4" r="2"/></svg>
              LinkedIn
            </a>
          </div>
        </div>
